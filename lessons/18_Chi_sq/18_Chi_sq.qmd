---
title: "Lesson 18: Chi-squared test"
...
-   If there are two groups, we could see if they had different proportions by testing if the proportions were the same (null) or different (alternative, two-sided, $\neq$)

 

-   What happens when we want to compare three **or more** groups' proportions?
...
-   **Independence**
    -   All individuals are independent from one another and each group is independent
...
::: columns
::: column
-   Recall the $p$-value = `r round(pv, 10)`
-   Use $\alpha$ = 0.05
