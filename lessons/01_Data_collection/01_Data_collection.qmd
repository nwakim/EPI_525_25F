...
::: columns
::: {.column width="50%"}
- [**Simple random sample (SRS)**]{style="color: #EF85B3;"}
...
- [**Stratified sampling**]{style="color: #E75B5C;"}
...
::: columns
::: {.column width="50%"}
- [**Cluster sample**]{style="color: #BF396F;"}
...
- [**Multistage sample**]{style="color: #459B99;"}
...
- [**Simple random sample:**]{style="color: #EF85B3;"} randomly select 1,000 students from all 50,000 students
- [**Stratified sampling:**]{style="color: #E75B5C;"} we create strata based on rural and urban schools, and then we randomly select 500 students from rural schools and 500 students from urban schools
    - The thought here is that rural schools are typically further from health clinics
- [**Cluster sample:**]{style="color: #BF396F;"} randomly select 10 schools, then include all students from those schools
- [**Multistage sample:**]{style="color: #459B99;"} randomly select 10 schools, then randomly select 20 students from each selected school 
