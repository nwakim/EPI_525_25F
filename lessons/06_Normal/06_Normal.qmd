...
1.  Understand how probability distributions extend to continuous
    distributions
2.  Calculate probabilities for specific events using a Normal
    distribution
3.  Apply the Normal distribution to approximate probabilities for
    binomial events
...
1.  Draw on standard Normal curve:
    ![](../img_slides/standard_normal.png){width="760"}
:::
...
## Example: Using Normal distribution in word problems (1/4)
...
## Example: Using Normal distribution in word problems (2/4)
...
::::: columns
::: column
-   Draw on a normal curve: ![](../img_slides/normal.png){width="750"}
:::
...
## Example: Using Normal distribution in word problems (3/4)
...
## Example: Using Normal distribution in word problems (4/4)
