---
title: "Lesson 11: Confidence intervals"
...
We are 95% confident that the population mean height is between `r round(66.1-1.96*3/sqrt(50), 3)` and `r round(66.1+1.96*3/sqrt(50), 3)` inches.
...
The figure shows CI's from 100 samples:

-   100 samples: I find the mean and confidence interval of each sample
...
- Recall example: "We are 95% confident that the population mean height is between `r round(66.1-1.96*3/sqrt(50), 3)` and `r round(66.1+1.96*3/sqrt(50), 3)` inches."
