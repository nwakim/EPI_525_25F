---
title: "Lesson 10: Variability in estimates"
...
- If a sample consists of **at least 30 independent observations in EACH sample**, then the [**sampling distribution**]{style="color:#E75B5C"} of the sample mean is **approximated by a normal model**
...
- Aka, for **"large" sample sizes** ( $n\geq 30$ ),
    * The [**sampling distribution**]{style="color:#E75B5C"} of the sample mean can be approximated by a __normal distribution__,with 
      ...
      * Standard deviation $\frac{\sigma}{\sqrt{n}}$
        - This is actually referred to as **standard error**: a quick way to say "the standard deviation of the sampling distribution of the sample mean"
...
* For **small sample sizes** (when $n < 30$), if the **population is known to be normally distributed**, then
    * The [**sampling distribution**]{style="color:#E75B5C"} of the sample mean is a __normal distribution__, with 
      ...
      * Standard deviation $\frac{\sigma}{\sqrt{n}}$ (aka standard error)
...
## Summary Review: Point Estimate and Variance Terminology
