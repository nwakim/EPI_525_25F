---
title: "Lesson 13: Inference for mean difference from two-sample dependent/paired data (Hypothesis testing 2)"
...
1.  Define paired data and explain how it differs from independent 1-sample data.
...
- Inference for a single-sample mean includes:
  ...
  1. Confidence intervals (Lesson 11)
  2. Hypothesis testing (Lesson 12)
      - Find p-value and compare to $\alpha$
:::
::: column
Single-sample mean under the null distribution:
...
4-5. Calculate t-statistic and p-value
:::
...
- Using $d$ (for difference) helps us distinguish between a single sample and paired data
...
-   How do we answer this question?
    ...
    - Then find CI or perform hypothesis test on the difference
...
-   The mean difference (insert measure) in the sample was $\overline{x}_d$ (95% CI \_\_\_,\_\_\_), which is not discernibly different from $\delta_0$ ( $p$-value = \_\_\_\_).
:::
:::::
::::::
:::::::::::
