...
See some repeat questions from Fall 2024 below!!

### 1. The last question about calculating P(A and B). When can you use the P(A)P(B) definition and when can you not? Maybe some more examples would help.

When you **know** events A and B are independent, then you can say $P(A \text{ and } B) = P(A)P(B)$. If you do not know that A and B are independent, then you cannot use this formula.
...
[Please follow this link for my work through of the example.](https://ohsuitg-my.sharepoint.com/:v:/r/personal/wakim_ohsu_edu/Documents/Teaching/Classes/EPI_525_25F/Student_files_EPI_525/Recordings/03_Probability_example.mp4?csf=1&web=1&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=IOo5wn) And [here is the PDF with my work](/lessons/03_Probability/03_Probability_example.pdf).
