...
- Become familiar with the console and a script file
- Run some math calculations in R!
- Assign things in R
- Use functions to calculate 
- Familiarize ourselves with common issues
- Troubleshoot with different tools
